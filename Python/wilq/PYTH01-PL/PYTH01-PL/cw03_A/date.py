...
commands = [
    "teraz.strftime('%d-%m-%Y')",
    "teraz.strftime('%d-%b-%Y')",
    "teraz.strftime('%d %B %Y')",
    "teraz.strftime('%d %B %Y, %a')",
    "teraz.strftime('%d %B %Y, %A')",
    "teraz.strftime('%x')",
    "locale.setlocale(locale.LC_ALL, 'pl.utf8')",
    "teraz.strftime('%x')"
]
execute(commands, globals(), 'Formatowanie daty:')
commands = [
    "teraz.strftime('%x')"
]
execute(commands, globals(), 'domyślny lokalizator')

commands = [
    "locale.setlocale(locale.LC_ALL, 'pl.utf8')",
    "teraz.strftime('%x')"
]
execute(commands, globals(), 'lokalizator polski')

commands = [
    "teraz.strftime('%H:%M:%S')",
    "teraz.strftime('%I:%M:%S %p')"
]
execute(commands, globals(), 'Formatowanie czasu:')
'''
